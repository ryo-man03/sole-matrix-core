...
const entryCards = [
  { eyebrow: "01 / PREFERENCE", title: "8問で好みを整理する", description: "商品を決めていなくても始められます。具体的なモデル名と参考リンクまで表示します。", items: ["8問を1問ずつ進める", "Gemini候補を検証してCoreで再評価", "失敗時も具体モデルのfallbackを表示"] },
