...
export async function POST(request: Request) {
  ...
  if (!isRecord(body) || !hasOnlyKeys(body, ["email", "password"]) || typeof body.email !== "string" || typeof body.password !== "string" || body.email.length > 254 || body.password.length > 200) return invalid();
