...
export const PROVIDER_POLICY_REGISTRY: readonly ProviderPolicyRecord[] = [
  { provider: "rakuten", verificationStatus: "implemented_unverified", temporaryDisplay: "allowed", persistence: "prohibited", forecast: "prohibited", recommendationScore: "prohibited" },
  { provider: "yahoo", verificationStatus: "live_verified", temporaryDisplay: "allowed", persistence: "prohibited", forecast: "prohibited", recommendationScore: "prohibited" },
